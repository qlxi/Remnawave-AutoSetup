<div align="center">
  ...
  <div style="display: flex; justify-content: center; gap: 15px; margin-top: 20px;">
    ...
    <img src="https://img.shields.io/badge/Version-v0.1%20(Beta)-orange" alt="版本">
...
- **安全性**
  - 高级加密：采用最先进的加密协议，确保最大安全性
  - 防攻击系统：内置防护系统，抵御 DDoS 和其他网络攻击
  - IP 隐藏：高级 IP 掩码和保护功能
  - 多层安全：多重安全层保护您的数据
...
- **技术特性**
  - Docker 集成：完整的 Docker 容器化支持
  - Nginx 集成：高级 Web 服务器配置
...
### JWT ###
### 更改默认值 ###
JWT_AUTH_SECRET=您的第一个十六进制代码
JWT_API_TOKENS_SECRET=您的第二个十六进制代码
...
SUB_PROFILE_TITLE=订阅档案
SUB_UPDATE_INTERVAL=12
SUB_WEBPAGE_URL=https://您的子域名

### SUBSCRIPTION PUBLIC DOMAIN ###
### 原始域名，不带 HTTP/HTTPS，域名末尾不要加 / ###
SUB_PUBLIC_DOMAIN=rw.guilanit.com

EXPIRED_USER_REMARKS=["订阅已过期","请联系支持"]
DISABLED_USER_REMARKS=["订阅已禁用","请联系支持"]
LIMITED_USER_REMARKS=["订阅受限","请联系支持"]
...
### 此密钥用于签署 webhook 负载，必须正好 64 个字符。仅允许 a-z, 0-9, A-Z ###
